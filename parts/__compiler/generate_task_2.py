...
if r_hat > 0:
    print(r"є прямий, тобто якщо зростає "+ f"{settings.task_1_y_meaning}" +r", то і зростає "+ f"{settings.task_1_x_meaning}" +r", або коли спадає "+ f"{settings.task_1_y_meaning}" +r", спадає і "+ f"{settings.task_1_x_meaning}" +r". Але слід провести тест на перевірку значущості коефіцієнта кореляції.\\")
else:
    print(r"є обернений, тобто якщо зростає "+ f"{settings.task_1_y_meaning}" +r", то "+ f"{settings.task_1_x_meaning}" +r" спадає, або коли спадає "+ f"{settings.task_1_y_meaning}" +r", росте "+ f"{settings.task_1_x_meaning}" +r". Але слід провести тест на перевірку значущості коефіцієнта кореляції.\\")
...
if t_st > 2.0484:
    print(r"Зa результатами тесту $t_{CT}>t_{KP}$ тому гіпотеза  $H_{A}$ приймається з ймовірністю 90\%, тобто $r\neq0$, а це означає, що існує залежність між "+ f"{settings.task_1_y_meaning}" +r" і "+ f"{settings.task_1_x_meaning}" +r". ")
else:
    print(r"Зa результатами тесту $t_{CT}<t_{KP}$ тому гіпотеза  $H_{0}$ приймається з ймовірністю 90\%, тобто $r=0$, а це означає, що не існує залежності між "+ f"{settings.task_1_y_meaning}" +r" і "+ f"{settings.task_1_x_meaning}" +r". ")
...
Ми можемо зробити висновок про відсутність залежності між """+ f"{settings.task_1_y_meaning}" +r""" і """+ f"{settings.task_1_x_meaning}" +r""". 
\newpage""")